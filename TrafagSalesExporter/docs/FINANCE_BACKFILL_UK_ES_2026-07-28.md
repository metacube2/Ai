...
1. `TRUK_2025.xlsx` nach SharePoint `Import/Finance/UK_B1` hochladen und **dort liegen lassen**.
2. Standortexport fuer TRUK ausfuehren.
3. Gegenpruefen: TRUK muss danach ~1'868 zusaetzliche 2025er Zeilen haben; Summe 2025
   ca. `395'605.82 GBP`.
