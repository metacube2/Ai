...
| — | Sales Database | Lieferant wird bei sehr vielen Gesellschaften nicht angezeigt | **Fallback umgesetzt, Deploy wartet auf gemeinsamen SAP-Release** | **Sehr hoch** | **App / Standorte** | Nach SAP-Aktivierung von ZDISPO gemeinsam deployen; MARC-1100-Cache backfillen und die verbleibenden 12'023 unklaren Fallback-Zeilen nach Land/Quelle bearbeiten | Neuer Default: Fremdstandort ohne Supplier/Sales Type gegen CH-Werkstamm MARC 1100; auf alte MBEW-Regel umschaltbar. Messung: +720 Zeilen / +392 Materialien intern, 0 Verluste; weiterhin expliziten Supplier nicht ueberschreiben. `FINANCE_SUPPLIER_FALLBACK_UMSCHALTER_2026-08-11.md` |
