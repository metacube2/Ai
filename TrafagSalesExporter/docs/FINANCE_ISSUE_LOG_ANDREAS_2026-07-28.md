...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 3 | TR UK Sales | Daten TR UK fuer 2025 fehlen | **ERLEDIGT, live verifiziert 2026-07-31** | - | - | Keine Aktion | Produktiv: 1'867 Zeilen fuer 2025 und 1'090 fuer 2026; alle 2'957 TRUK-Zeilen mit SupplierNumber, SupplierName und SupplierCountry. Kanonischer Nachweis: `docs/AKTUELLER_LIVEDATEN_STAND_2026-07-31.md`. |
...
| — | Sales Database | Lieferant wird bei sehr vielen Gesellschaften nicht angezeigt | **Bestaetigt und quantifiziert** | **Sehr hoch** | **Andreas (Fachentscheid)** | Entscheiden, ob CH/AT per Regel als eigene Lieferkategorie gelten soll | `69'919` von `84'788` Zeilen (82.5 %) ohne Lieferant; die drei Felder sind ausnahmslos GEMEINSAM leer -> Mapping-, kein Pflegeproblem. **`63'008` Zeilen haben Kosten, zeigen aber keine Marge.** `FINANCE_SUPPLIER_LUECKE_ANALYSE_2026-07-28.md` |
...
- **Supplier-Issue** — Fachentscheid Andreas (63'008 maskierte Zeilen).
