...
| Claude | Doku / Repo-weite Markdown-Aufraeumung und neue Router-Hierarchie | ALLE `.md`-Dateien im Repo ausser vendor-Code (`whisper/python/Lib/site-packages/**`) und ausser fachfremden Bereichen laut Absprache 1, insbesondere `docs/**`, `AGENTS.md`, `CLAUDE.md`, neu `router.md`, `baum.md`, neue Unterrouter | **LAEUFT**, gestartet 2026-08-17. Plant Konsolidierung, Loeschung veralteter Inhalte und eine neue hierarchische Navigation (`router.md` als einziger globaler Einstieg, Unterrouter je Themenast, `baum.md` als Vollstaendigkeitsindex). Andere Agenten bitte in dieser Zeitspanne KEINE `.md`-Dateien anfassen, um Konflikte zu vermeiden. Wird nach Abschluss mit Ergebnis, gelöschten/zusammengeführten Dateien und Commit-Hash nachgetragen. |
