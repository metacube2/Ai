# RAG-Router-Archiv 2026-07-31

Vollstaendiger Stand von `docs/RAG_ROUTER.md` vor der Aufteilung in kompakten
Router und Detailindex. Nur fuer Audit/Wiederherstellung verwenden.
