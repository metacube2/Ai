# Lastchange-Archiv (Eintraege bis 2026-07-12)

Verbatim aus `lastchange.md` verschoben am 2026-07-17 (MD-Aufraeumaktion).
Zweck: Historie vollstaendig erhalten, aktive Datei tokenarm halten.
Neuere Eintraege (ab 2026-07-13): `lastchange.md`. Themen-Details: jeweilige Doku laut `docs/RAG_ROUTER.md`.
Noch aeltere kanonische Historie: `HISTORY_CANONICAL.md.raw` im selben Ordner.

## Kurzstand-Eintraege 2026-06-04 bis 2026-07-08 (verschoben aus 'Aktueller Kurzstand')
