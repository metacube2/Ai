...
- Neu umgesetzt, getestet und deployed am 2026-06-17: Zentraler Export laedt progressiv. `Sales_All_<Datum>.xlsx` wird direkt nach Erzeugung nach SharePoint geladen, danach `Finance_Dashboard_Audit_All_<Datum>.csv`. Das schwere `Finance_Dashboard_Nachweis_<Datum>.xlsx` wird im gleichen Buttonlauf nur bis `50'000` Zentralzeilen erzeugt; bei groesseren Datenmengen wird es uebersprungen und die Audit-CSV ist der vollstaendige Detailnachweis. Doku: `docs/FINANCE_DASHBOARD_NACHWEIS_2026-06-17.md`.
