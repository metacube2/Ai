...
public class DatabaseSeedService : IDatabaseSeedService
{
    ...
    [
        ...
        Link("finance-pivot", "experts", "Finance Pivot", "Finance pivot", "TableChart", "management-cockpit?section=pivot", 70, "All"),
        Link("division-finance", "experts", "Sparten-Finanzanalyse", "Division finance", "PieChart", "management-cockpit?section=division&division=finance", 80, "All"),
        Link("division-central", "experts", "Zentrale Spartenzuordnung", "Central division mapping", "AccountTree", "management-cockpit?section=division&division=central", 90, "All"),
        Link("finance-audit-ledger", "experts", "Finance Pruefbuch", "Finance audit ledger", "FactCheck", "management-cockpit?section=ledger", 100, "All"),
    ...
    private static void EnsureSapODataDachMapping(AppDbContext db, int siteId)
    {
        ...
        var mappings = new (string Target, string Source, bool Required)[]
        {
            ...
            (nameof(SalesRecord.StandardCost), "Z.ResolvedStandardCost", false),
            (nameof(SalesRecord.StandardCostCurrency), "Z.ResolvedStandardCostCurrency", false),
